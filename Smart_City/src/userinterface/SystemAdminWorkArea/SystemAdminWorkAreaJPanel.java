...
public class SystemAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void enableEButton(){
        for(Network n: system.getNetworkList())
        if(n.getEnterpriseDirectory().getEnterpriseList()!=null){
            manageEnterpriseJButton.setEnabled(true);
        }
       
    }
    public void enableEMButton(){
        
        for(Network n : system.getNetworkList()){
           if(n.getEnterpriseDirectory().getEnterpriseList().size()!=0){
            manageAdminJButton.setEnabled(true);
        }
        }
    ...
    private void initComponents() {
        ...
        manageAdminJButton.setEnabled(false);
        ...
        manageEnterpriseJButton.setEnabled(false);
